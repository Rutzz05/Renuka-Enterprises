      ...
      <section className="relative overflow-hidden print:hidden">
        ...
        <div className="relative container py-10 text-white">
          ...
          <div className="mt-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="text-flex-wrap gap-3">
              <Button 
                variant="outline" 
                className="border-white/25 bg-white/10 text-white hover:bg-white/20 gap-2 transition-all hover:scale-105"
              ...
              <Button 
                className="bg-white text-primary hover:bg-white/90 gap-2 transition-all hover:scale-105 disabled:opacity-50"
                onClick={handleDownloadPDF}
                disabled={generatingPDF}
              >
                <Download className="h-4 w-4" />
                <span className="hidden sm:inline">{generatingPDF ? "Generating..." : "Download PDF"}</span>
                <span className="sm:hidden">{generatingPDF ? "..." : "PDF"}</span>nt="outline" className="border-white/25 bg-white/10 text-white hover:bg-white/20" onClick={() => window.print()}>
                <Printer className="mr-2 h-4 w-4" />
                Print
              </Button>
              <Button className="bg-white text-primary hover:bg-white/90" onClickProduct Invoice</h2>
        ...
        <Card className="rounded-[32px] border-0 shadow-[0_24px_70px_-45px_rgba(15,23,42,0.5)] print:shadow-none">
          <CardContent className="p-8 md:p-10">
            <div className="flex flex-col gap-8 border-b pb-8 md:flex-row md:items-start md:justify-between">
              <div>
                <p className="text-sm font-segradient-to-br from-slate-50 to-slate-100 p-6 border border-slate-200/50 transition-all hover:shadow-lg">
              ...
              <div className="rounded-3xl bg-slate-50 p-6">
                ...
                </div>gradient-to-br from-primary/10 to-primary/5 p-6 border border-primary/20">
              ...
              <div className="mt-4 pt-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-3tion}-${index}`} className="grid grid-cols-12 border-t px-5 py-4 text-sm">
            ...
            <div className="mt-8 ml-auto max-w-sm rounded-3xl bg-primary/[0.04] p-6">
              ...
              <div className="mt-3 flex items-center justify-between text-sm">
                <span className="text-slate-600">Tax</span>amber-200 bg-amber-50/50 p-5 text-sm text-slate-600">
